...
<!DOCTYPE html>
<html>
    <link rel="stylesheet" href="nostriprodotti.css">
    <script src="nostriprodotti.js" defer="true"></script>
    <head>
      <meta charset="utf-8">
    ...
    <body>
        ...
        <div id="intestazione">
            <h1>Menu</h1>
            <h2>Quanto è grande la tua fame?</h2>
            <p>Quando da McDonald’s la fame chiama, ognuno ha i propri gusti, ma tutti partono da una scelta: quanto devono essere grandi le patatine e la bevanda da accompagnare al proprio panino preferito?</p>
        </div>
        <article id="top">
            
            <form id="question" method="GET">
              <h3>Scrivi una delle nostre tipologie di prodotto</h3>
              <div id="ricerca">
              <input type='text' id='alimento' placeholder='panini,patatine,insalate e gelati'>
