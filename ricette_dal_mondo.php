...
<!DOCTYPE html>
<html>
    <link rel="stylesheet" href="ricette_dal_mondo.css">
    <script src="ricette_dal_mondo.js" defer="true"></script>
    <head>
      <meta charset="utf-8">
    ...
    <body>
        ...
        <div id="intestazione">
            <h1>Scopri le ricette nel mondo</h1>
            <p>Scegli tu la tipologia di ricetta che vuoi vedere</p>
        </div>
        ...
        <article id="top">
            ...
            <form id="question" method="GET">
              <h3>Scrivi qui il piatto o l'alimento di cui vuoi vedere le ricette</h3>
              <div id="ricerca">
              <input type='text' id='alimento'>
